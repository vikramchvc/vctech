...
import "../App.css";
import { summarise } from "../reducer/Actions";
...
function Transscript() {
    ...
    const handleTranslate = async () => {
        const link = "https://www.youtube.com/watch?v=q6kJ71tEYqM"
        setLoading(true);
        try {
          const responseData = await summarise(link);
    ...
    return (
        <div id="contentToCopy">
            {summaryContent["title"]===undefined?(
